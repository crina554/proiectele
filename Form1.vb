Public Class frmCronometru
    ...
    Private Sub tmrCeas_Tick(sender As Object, e As EventArgs) Handles tmrCeas.Tick
        ...
        txtZecimi.Text = TimeOfDay.Millisecond.ToString("00")
    End Sub
    ...
    Private Sub frmCronometru_Load(sender As Object, e As EventArgs) Handles MyBase.Load
